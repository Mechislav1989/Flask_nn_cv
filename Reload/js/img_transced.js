...
function init() {
  ...
  var l2 = new THREE.ImageLoader();
	...
	l2.load('C:\Users\ysatr\PycharmProjects\Visual_code\img\1_-Cover-Python-corso-base---istruzioni-per-l-uso---square.jpg', function(img) {
		slide2.setImage(img);
	})
...
function Slide(width, height, animationPhase) {
  ...
  function getControlPoint0(centroid) {
    ...
    tempPoint.y = signY * THREE.Math.randFloat(0.1, 0.3) * 170;
